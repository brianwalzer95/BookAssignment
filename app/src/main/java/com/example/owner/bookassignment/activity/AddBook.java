...
import com.example.owner.bookassignment.entity.Book;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(title == null)
                {
                    Toast.makeText(AddBook.this, "Please enter in a Title", Toast.LENGTH_SHORT).show();
                }
                else if (author == null)
                {
                    Toast.makeText(AddBook.this, "Please enter in author", Toast.LENGTH_SHORT).show();
                }
                else if (price == null)
                {
                    Toast.makeText(AddBook.this, "Please enter in a price", Toast.LENGTH_SHORT).show();
                }
                else if (quantity <= 0)
                {
                    Toast.makeText(AddBook.this, "Please enter in a quantity", Toast.LENGTH_SHORT).show();
                }
                ...
                ref.putFile(filePath)
                        .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                Intent intent = new Intent(AddBook.this, AWelcome.class);
